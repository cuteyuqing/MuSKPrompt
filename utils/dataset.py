...
class YELPPDataset(BASEDataset):
    def __init__(
        self,
        data_dir,
        mode
...
class MRPCDataset(BASEDataset):
    def __init__(
        ...
        """data key: sentence, label[0/1] 0equivalent 1not_equivalent"""
        super().__init__(data_dir, mode)
        self.label2id = {0: 0, 1: 1}

        # self.label2verb = {0: 'true', 1: 'false'}
        # self.id2verb = ['true', 'false']
        self.label2verb = {0: 'no', 1: 'yes'}
        self.id2verb = ['no', 'yes']
...
class SNLIDataset(BASEDataset):
    def __init__(
        ...
        """data key: sentence, label[0/1] 0entailment 1neutral 2contradiction"""
        super().__init__(data_dir, mode)
        
        self.label2id = {0: 0, 1: 1, 2: 2}
        self.label2verb = {0: 'true', 1: 'neither', 2: 'false'}
        self.id2verb = ['true', 'neither', 'false']
...
class RTEDataset(BASEDataset):
    def __init__(
        ...
        # self.label2verb = {'not_entailment': 'no', 'entailment': 'yes'}
        # self.id2verb = ['no', 'yes']
